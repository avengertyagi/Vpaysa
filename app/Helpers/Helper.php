...
class Helper
{
	public static function sendmail($userDetails = array())
	{
		$html = '<!DOCTYPE html>
				<html lang="en">
				<head>
				...
				<body>
					<div class="container">
					  <div class="box">
						...
						<p>You have forgotten your password, no problem we are here to help you.</p>
		...
		$message = "send mail successfully".$html;
		$email = new \SendGrid\Mail\Mail();
		$email->setfrom("sugam.omnisttechhub@gmail.com");
		$email->setSubject($subject);
		$email->addTo($userDetails['email']);
		$email->addContent("text/plain", "subject");
		$email->addContent("text/html", $message);
		$sendgrid = new \SendGrid('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');
		$sendgrid->send($email);
	}
